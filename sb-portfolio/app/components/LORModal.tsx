...
export default function LORModal() {
  ...
  return (
    <>
      <Button className='md:ml-32 mt-8 md:p-8 border-1 border-bismark text-bismark bg-opacity-0 hover:transition-all duration-75 hover:-translate-y-1 hover:-translate-x-1 ease-in rounded-md text-lg md:text-xl lor-button' onClick={onOpen}>See What They Said</Button>
